...
category_groups = {
    ...
    Category.HEALTH: {
        "categories": ["lekarstwa"],
        "priority": priority.Priority.ESSENTIAL,
    },
    Category.BEAUTY: {
        "categories": ["kosmetyki", "uroda, fryzjer, kosmetyczka"],
        "priority": priority.Priority.HAVE_TO_HAVE,
    },
    ...
    Category.FUN: {
        "categories": ["restauracje i kawiarnie", "fotografia", "multimedia"],
        "priority": priority.Priority.NICE_TO_HAVE,
    },
    Category.BILLS: {
        "categories": [
